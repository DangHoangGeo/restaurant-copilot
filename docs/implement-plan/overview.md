...
Below, each major step is laid out in sequence. Wherever a step satisfies one or more checklist items, we reference them in parentheses. For example, “(Req 2.1.1)” refers to Checklist Section 2.1.1: Monorepo Structure & Tooling.

---

## C. Summary of Links to Requirements Checklist

* **1. Foundational & Security** → Checklist 1.1 – 1.7
* **2. Database & RLS** → Checklist 2.1 – 2.6
* **3. Tenant Registration & Subdomain** → Checklist 3.1 – 3.5
* **4. Admin Dashboard** → Checklist 4.1 – 4.6
* **5. Customer Website** → Checklist 5.1 – 5.10
* **6. Staff iOS App** → Checklist 6.1 – 6.10
* **7. Reports & Feedback** → Checklist 7.1 – 7.4
