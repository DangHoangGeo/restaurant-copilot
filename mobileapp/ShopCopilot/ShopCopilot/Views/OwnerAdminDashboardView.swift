...
struct OwnerAdminDashboardView_Previews: PreviewProvider {
    static var previews: some View {
        // Create mock view models for the preview.
        let authVM = AuthenticationViewModel()
        authVM.currentUsername = "TestAdmin" // Simulate a logged-in user

        let tenantVM = TenantViewModel()
        tenantVM.currentTenant = Tenant(id: UUID(), name: "Preview Tenant", subdomain: "preview", logoUrl: nil, primaryColorHex: nil, coverImageUrl: nil) // Simulate a selected tenant
