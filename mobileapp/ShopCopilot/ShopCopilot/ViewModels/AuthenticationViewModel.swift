import Foundation
import Combine
import Supabase // Required for Session type if used directly, or for SupabaseClient in logout
...
class AuthenticationViewModel: ObservableObject {
    ...
    private func parseJWTAndStoreClaims(token: String, isInitialLaunch: Bool = false, currentLoginEmail: String? = nil) {
