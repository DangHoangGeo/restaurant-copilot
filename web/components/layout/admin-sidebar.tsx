...
import {
  Home, Settings, ClipboardList, TableIcon as TableSimpleIcon, UserCog, 
  BarChartBig, Eye, X, BookUser, Palette,
  LucideIcon
} from 'lucide-react';
...
export function AdminSidebar({ restaurantSettings, isOpen, setIsOpen }: AdminSidebarProps) {
  ...
  const NavItem = ({ icon: IconComponent, labelKey, href, exact = false, isUtility = false }: NavItemProps) => {
