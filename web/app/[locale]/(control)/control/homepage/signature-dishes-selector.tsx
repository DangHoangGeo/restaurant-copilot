                ...
                <Card key={item.id} className="overflow-hidden">
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="bg-yellow-100 text-yellow-700 text-xs px-2 py-1 rounded flex items-center gap-1">
              ...
              >
                {item.image_url && (
                  <div className="relative h-32">
                    ...
                    />
                    {item.is_signature && (
                      <div className="absolute top-2 right-2 bg-yellow-500 text-yellow-50 text-xs px-2 py-1 rounded flex items-center gap-1">
                        <Star className="h-3 w-3" />
                        {t('badge.signature')}
                      </div>
                    )}
