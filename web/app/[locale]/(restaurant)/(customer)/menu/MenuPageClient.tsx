...
export function MenuPageClient({ locale, categories }: MenuPageClientProps) {
      ...
      <Dialog open={showGuestDialog} onOpenChange={setShowGuestDialog}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={startSession}>{t("start_session")}</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={showJoinDialog} onOpenChange={setShowJoinDialog}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={joinSession}>{t("join")}</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
