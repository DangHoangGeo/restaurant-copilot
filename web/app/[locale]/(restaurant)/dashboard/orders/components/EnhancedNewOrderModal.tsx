...
interface EnhancedNewOrderModalProps {
  isOpen: boolean;
  onClose: () => void;
  tables: TableType[];
  categories: Category[];
...
export function EnhancedNewOrderModal({
  isOpen,
  onClose,
  tables,
  categories,
  ...
  return (
    <>
        ...
        <DialogContent className="max-w-6xl max-h-[95vh] p-0 flex flex-col">
          ...
          <div className="flex-1 overflow-hidden min-h-0">
            ...
            <div className="flex flex-col md:flex-row h-full">
              {/* Menu Items Panel */}
              <div className="md:w-2/3 border-r-0 md:border-r border-gray-200 flex flex-col min-h-0">
              ...
              <div className="hidden md:flex md:w-1/3 flex-col bg-gray-50 border-t md:border-t-0 border-gray-200">
                {/* Order Header - Sticky */}
          ...
          <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg p-4 z-50 animate-in slide-in-from-bottom duration-300">
            <div 
              className="flex items-center justify-between mb-3 cursor-pointer hover:bg-gray-50 p-2 rounded-lg -m-2 transition-colors"
      ...
      <Dialog open={isMobileOrderSummaryOpen} onOpenChange={setIsMobileOrderSummaryOpen}>
        <DialogContent className="max-w-sm max-h-[80vh] p-0 flex flex-col">
          <DialogHeader className="p-4 pb-0 border-b border-gray-200 shrink-0">
            <DialogTitle className="text-lg font-semibold">
              Order Summary
            </DialogTitle>
